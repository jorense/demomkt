						...
						<div class="contact-form1">
							<div class="row contact-form-content">
								<div class="col-xs-12">
									...
									<form class="contact1 page" method="post" action="phase1/include/ajax.php">
										...
										<div class="form-groups msg-group">
											<textarea name="message" rows="0" cols="0" class="form-controls message" required></textarea>
											<span class="bars bp-ab"></span>
												...
												<div class="form-group">
													<label class="form-check">Others.
														<div class="specify bp-set vm">
															<input type="text" name="" value="" placeholder="Please Specify">
														</div>
													  <input type="checkbox">
													  <span class="checkmark"></span>
													</label>
