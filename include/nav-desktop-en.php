									...
									<div class="col-xs-3">
										<div class="m-d-left">
											<ul>
												...
												<li data-tab="tab-2">
													<a><i class="pw"><img src="dist/images/icons/communication.svg" width="29" height="25" alt="" title=""></i><span>Communication, Media, High-Tech &amp; Utilities</span></a>
												</li>
												<li data-tab="tab-3">
												...
												<div class="m-d-right bp-rel">
													...
													<div class="row explore-in">
														...
														<div class="col-xs-6 mb2">
															...
															<p><a class="clickScroll" href="<?php echo $bankingFinancialServicesAndInsurance; ?>" data-id="solutions">Solutions For Banking, Financial Services &amp; Insurance</a></p>
														</div>
											...
											<div class="nav-tab tab-2">
												<div class="m-d-right bp-rel">
													<div class="row explore-in">
														...
														<div class="col-xs-6 mb2">
															<h3>Communication, Media, High-Tech &amp; Utilities</h3>
															<?php
															...
															?>
															<p><a class="clickScroll" href="<?php echo $communicationMediaUtilities; ?>" data-id="overview">Industry Overview</a></p>
															<p><a class="clickScroll" href="<?php echo $communicationMediaUtilities; ?>" data-id="story">Related Stories</a></p>
															<p><a class="clickScroll" href="<?php echo $communicationMediaUtilities; ?>" data-id="solutions">Solutions For Communication, Media, High-Tech &amp; Utilities </a></p>
														</div>
												...
												<div class="m-d-right bp-rel">
													<div class="row explore-in">
														...
														<div class="col-xs-6 mb2">
															...
															?>
															<p><a class="clickScroll" href="<?php echo $hospitality; ?>" data-id="overview">Industry Overview</a></p>
															<p><a class="clickScroll" href="<?php echo $hospitality; ?>" data-id="story">Related Stories</a></p>
															<p><a class="clickScroll" href="<?php echo $hospitality; ?>" data-id="solutions">Solutions For Hospitality</a></p>
														</div>
												...
												<div class="m-d-right bp-rel">
													<div class="row explore-in">
														...
														<div class="col-xs-6 mb2">
															...
															?>
															<p><a class="clickScroll" href="<?php echo $publicsector; ?>" data-id="overview">Industry Overview</a></p>
															<p><a class="clickScroll" href="<?php echo $publicsector; ?>" data-id="story">Related Stories</a></p>
															<p><a class="clickScroll" href="<?php echo $publicsector; ?>" data-id="solutions">Solutions For Public Sector</a></p>
														</div>
												...
												<div class="m-d-right bp-rel">
													<div class="row explore-in">
														...
														<div class="col-xs-6 mb2">
															...
															?>
															<p><a class="clickScroll" href="<?php echo $retailmanufacturingandlogistics; ?>" data-id="overview">Industry Overview</a></p>
															<p><a class="clickScroll" href="<?php echo $retailmanufacturingandlogistics; ?>" data-id="story">Related Stories</a></p>
															<p><a class="clickScroll" href="<?php echo $retailmanufacturingandlogistics; ?>" data-id="solutions">Solutions For Retail, Manufacturing &amp; Logistics</a></p>
														</div>
												...
												<div class="m-d-right bp-rel">
													<div class="row explore-in">
														...
														<div class="col-xs-6 mb2">
															...
															?>
															<p><a class="clickScroll" href="<?php echo $travelandtransportation; ?>" data-id="overview">Industry Overview</a></p>
															<p><a class="clickScroll" href="<?php echo $travelandtransportation; ?>" data-id="story">Related Stories</a></p>
															<p><a class="clickScroll" href="<?php echo $travelandtransportation; ?>" data-id="solutions">Solutions For Travel &amp; Transportation</a></p>
														</div>
												...
												<div class="m-d-right bp-rel">
													<div class="row explore-in">
														<div class="col-xs-6 mb2">
															...
															<p><a href="en/service/">Infinitum Overview</a></p>
															<p><a href="en/service/">Cloud</a></p>
															<p><a href="en/service/">Artificial Intelligence</a></p>
														</div>
														<div class="col-xs-6 mb2 mt2">

															<p><a href="en/service/">Digital Solutions</a></p>
															<p><a href="en/service/">Analytics</a></p>
															<p><a href="en/service/">IoT</a></p>
														</div>
													</div>
												...
												<div class="m-d-right bp-rel">
													<div class="row explore-in">
														<div class="col-xs-6 mb2">
															...
															<p><a href="en/service/">Overview</a></p>
															<p><a href="en/service/">Digital Banking</a></p>
															<p><a href="en/service/">Digital Insurance Platform</a></p>
															<p><a href="en/service/">In-store Digital Experience (AR/VR)</a></p>
														</div>
														<div class="col-xs-6 mb2 mt2">

															<p><a href="en/service/">Location-based Marketing</a></p>
															<p><a href="en/service/">Digital Supply Chain</a></p>
															<p><a href="en/service/">Omni-Channel Retailing</a></p>
														</div>
													</div>
												...
												<div class="m-d-right bp-rel">
													<div class="row explore-in">
														<div class="col-xs-6 mb2">
															<h3>Cloud</h3>
															<p><a href="en/service/">Overview</a></p>
															<p><a href="en/service/cloud-end-point-service">Cloud End-Point Service</a></p>
															<p><a href="en/service/cloud-management-suites">Cloud Management Suites</a></p>
															<p><a href="en/service/server-cloud">Server Cloud</a></p>

														</div>
														<div class="col-xs-6 mb2 mt2">

															<p><a href="en/service/virtual-desktop-infrastructure">Virtual Desktop Infrastructure</a></p>
															<p><a href="en/service/cloud-based-track-and-trac-platform">Cloud-Based Track-and-Trac Platform</a></p>
															<p><a href="en/service/infinitum-cloud-solutions-suite">Infinitum™ Cloud Solutions Suite</a></p>
															<p><a href="en/service/streaming-service-streaming-server-cluster">Streaming Service (Streaming Server Cluster)</a></p>
														</div>
													</div>
												...
												<div class="m-d-right bp-rel">
													<div class="row explore-in">
														<div class="col-xs-6 mb2">
															...
															<p><a href="en/service/">Overview</a></p>
															<p><a href="en/service/business-intelligence">Business Intelligence</a></p>
															<p><a href="en/service/">Artifical Intelligence</a></p>
														</div>
														<div class="col-xs-6 mb2 mt2">

															<p><a href="en/service/">Biometrics</a></p>
															<p><a href="en/service/">Ai-powered Personalization</a></p>
														</div>
													</div>
												...
												<div class="m-d-right bp-rel">
													<div class="row explore-in">
														<div class="col-xs-6 mb2">
															<h3>Analytics</h3>
															<p><a href="en/service/">Overview</a></p>
															<p><a href="en/service/">Customer Analytics</a></p>
															<p><a href="en/service/">Social Media Analytics</a></p>
														</div>
														<div class="col-xs-6 mb2 mt2">

															<p><a href="en/service/">Video Analytics</a></p>
															<p><a href="en/service/">Big Data Analytics &amp; Discovery Services</a></p>
															<p><a href="en/service/">Smart Contract</a></p>
														</div>
													</div>
												...
												<div class="m-d-right bp-rel">
													<div class="row explore-in">
														<div class="col-xs-6 mb2">
															<h3>IoT</h3>
															<p><a href="en/service/">Overview</a></p>
															<p><a href="en/service/">Smart Parking &amp; Charging</a></p>
															<p><a href="en/service/">IoT EAS Retail Solution</a></p>
														</div>
												...
												<div class="m-d-right bp-rel">
													<div class="row explore-in">
														<div class="col-xs-6 mb2">
															...
															<p><a href="en/service/oracle-enterprise-performance-management-system">Oracle ERP System</a></p>
														...
														<div class="col-xs-6 mb2">
															<h3>SAP Services</h3>
															<p class="pb3"><a href="en/service/sap-services">Overview</a></p>
												...
												<div class="m-d-right bp-rel">
													<div class="row explore-in">
														<div class="col-xs-6 mb2">
															...
															?>
															<p><a class="clickScroll" href="<?php echo $dataCenterOverview; ?>" data-id="data-center-overview">Data Center Overview</a></p>
															<p><a class="clickScroll" href="<?php echo $dataCenterOverview; ?>" data-id="our-commitment">Our Commitment</a></p>
															<p><a class="clickScroll" href="<?php echo $dataCenterOverview; ?>" data-id="unique-competitive-edge">Unique Competitive Edge</a></p>
														</div>
														<div class="col-xs-6 mb2">
															<h3>Services</h3>
															<?php
															...
															?>
															<p><a class="clickScroll" href="<?php echo $dataCenterCapabilities; ?>" data-id="data-center-design-and-build">Data Center Design and Build</a></p>
															<p><a class="clickScroll" href="<?php echo $dataCenterCapabilities; ?>" data-id="managed-services">Managed Services</a></p>
															<p><a class="clickScroll" href="<?php echo $dataCenterCapabilities; ?>" data-id="hosting-and-facility-management">Hosting &amp; Facility Management</a></p>
															<p><a class="clickScroll" href="<?php echo $dataCenterCapabilities; ?>" data-id="network-services">Network Services</a></p>
														</div>
													</div>
													<div class="row explore-in">
														<div class="col-xs-6 mb2">
															...
															<p><a href="en/data-center/d-infinitum-overview">D-Infinitum Global Alliance</a></p>
														</div>
													</div>
