...
<body>
	<div id="wrap">
        ...
        --><div id="content_wrap">
            <h1>Edit the content for the Infinitum section</h1>
		
            <div id="divider">&nbsp;</div>
            <h3 id="navigation_menu">Infinitum Content</h3>
            <p>The content pages of the Infinitum section</p>
            <?php 
				// Table variables
				$db_table = 'content_index';
				$input_form_id = '53';
				$reference_column = 'section';
				$reference_id = 'infinitum_content';
				// Bulkremove Variables
				$br_form = 'infinitum_content_bulkremove';
				$br_button = 'infinitum_content_button';
				$br_checkbox = 'infinitum_content_check';
			?>
                    	...
                    	<form class="<?php echo $br_form; ?>" method="post" action="bulkremove.php">
							...
							<?php
								...
								while($row = mysqli_fetch_array($result)) {
									...
									// Absolute Path (EN)
									if($active_en=='Yes') {
										$ab_semantic_url_en = $real_root_directory . 'en/infinitum/' . $semantic_url;
									...
									// Absolute Path (SC)
									if($active_sc=='Yes') {
										$ab_semantic_url_sc = $real_root_directory . 'sc/infinitum/' . $semantic_url;
									...
									// Relative Path (EN)
									if($active_en=='Yes') {
										$rel_semantic_url_en = 'en/infinitum/' . $semantic_url;
									...
									// Relative Path (SC)
									if($active_sc=='Yes') {
										$rel_semantic_url_sc = 'sc/infinitum/' . $semantic_url;
