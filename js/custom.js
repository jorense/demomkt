...
$(document).ready(function() {
	...
	// });
	//
	// $('.contact-submit, .skip').click(function(e){
	// 	$('.contact-form2').hide();
	// 	$('.contact-form3').show();
	//
	// 	setTimeout(function(){
	// 		// Contact Us Widget
	// 		$('.contact-us-box-widget.contact-us-box').fadeOut('500',function(){
	// 			$('.contact-us-box-widget .contact-form3').hide();
	// 			$('.contact-us-box-widget .contact-form1').show();
	// 		});
	//
	// 		// Contact Us Page
	// 		$('.contact-us-box-page .contact-form3').hide();
	// 		$('.contact-us-box-page .contact-form1').show();
	//
	// 		// Insight Form
	// 		$('.is-in-forms .contact-form3').hide();
	// 		$('.is-in-forms .contact-form2').show();
	// 	}, 3000);
	// });
	...
	$('.xp-list').mouseenter(function(){
		...
		var index = $('.xp-list').index(this);
		$('.xp-list-data').hide();
		$('.xp-list-data-'+index).show();
	...
	$('.w-w-d-list').mouseenter(function(){
		...
		var index = $('.w-w-d-list').index(this);
		$('.w-w-d-r-c-inner').hide();
		$('.w-w-d-r-c-inner-'+index).show();
	}).mouseleave(function(){
