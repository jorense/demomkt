...
<body>
	<div id="wrap">
        ...
        --><div id="content_wrap">
            <h1>Edit the content for the Insights section</h1>
		
            <div id="divider">&nbsp;</div>
            <h3 id="navigation_menu">Insight Index</h3>
            <p>The content of the Insight index</p>
            <?php 
				// Table variables
				$db_table = 'content_index';
				$input_form_id = '54';
				$reference_column = 'section';
				$reference_id = 'insight_index';
                    ...
                    <tbody>
						<?php
							...
							while($row = mysqli_fetch_array($result)) {
								...
								// Absolute Path (EN)
								if($active_en=='Yes') {
									$ab_semantic_url_en = $real_root_directory . 'en/insights/';
								...
								// Absolute Path (SC)
								if($active_sc=='Yes') {
									$ab_semantic_url_sc = $real_root_directory . 'sc/insights/';
								...
								// Relative Path (EN)
								if($active_en=='Yes') {
									$rel_semantic_url_en = 'en/insights/';
								...
								// Relative Path (SC)
								if($active_sc=='Yes') {
									$rel_semantic_url_sc = 'sc/insights/';
            ...
            <div id="divider">&nbsp;</div>
            <h3 id="navigation_menu">Insight Content</h3>
            <p>The content pages of the Insight section</p>
            <?php 
				// Table variables
				$db_table = 'content_index';
				$input_form_id = '53';
				$reference_column = 'section';
				$reference_id = 'insight_content';
				// Bulkremove Variables
				$br_form = 'insight_content_bulkremove';
				$br_button = 'insight_content_button';
				$br_checkbox = 'insight_content_check';
			?>
                    	...
                    	<form class="<?php echo $br_form; ?>" method="post" action="bulkremove.php">
							...
							<?php
								...
								while($row = mysqli_fetch_array($result)) {
									...
									// Absolute Path (EN)
									if($active_en=='Yes') {
										$ab_semantic_url_en = $real_root_directory . 'en/insight/' . $semantic_url;
										$ab_semantic_url_en = '<a href="' . $ab_semantic_url_en . '" target="_blank">' . $ab_semantic_url_en . '</a>';	
									}
									else {
										$ab_semantic_url_en = '';
									...
									// Absolute Path (SC)
									if($active_sc=='Yes') {
										$ab_semantic_url_sc = $real_root_directory . 'sc/insight/' . $semantic_url;
										$ab_semantic_url_sc = '<a href="' . $ab_semantic_url_sc . '" target="_blank">' . $ab_semantic_url_sc . '</a>';
									}
									else {
										$ab_semantic_url_sc = '';
									...
									// Relative Path (EN)
									if($active_en=='Yes') {
										$rel_semantic_url_en = 'en/insight/' . $semantic_url;
										$rel_semantic_url_en = '<a href="../../' . $rel_semantic_url_en . '" target="_blank">' . $rel_semantic_url_en . '</a>';	
									}
									else {
										$rel_semantic_url_en = '';
									...
									// Relative Path (SC)
									if($active_sc=='Yes') {
										$rel_semantic_url_sc = 'sc/insight/' . $semantic_url;
										$rel_semantic_url_sc = '<a href="../../' . $rel_semantic_url_sc . '" target="_blank">' . $rel_semantic_url_sc . '</a>';
									}
									else {
										$rel_semantic_url_sc = '';
