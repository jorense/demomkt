...
<body>
	<div id="wrap">
        ...
        --><div id="content_wrap">
            <h1>Edit the content for the Data Center section</h1>
		
            <div id="divider">&nbsp;</div>
            <h3 id="navigation_menu">Data Center Content</h3>
            <p>The content pages of the Data Center section</p>
            <?php 
				// Table variables
				$db_table = 'content_index';
				$input_form_id = '53';
				$reference_column = 'section';
				$reference_id = 'datacenter_content';
				// Bulkremove Variables
				$br_form = 'datacenter_content_bulkremove';
				$br_button = 'datacenter_content_button';
				$br_checkbox = 'datacenter_content_check';
			?>
                    	...
                    	<form class="<?php echo $br_form; ?>" method="post" action="bulkremove.php">
							...
							<?php
								...
								while($row = mysqli_fetch_array($result)) {
									...
									// Absolute Path (EN)
									if($active_en=='Yes') {
										$ab_semantic_url_en = $real_root_directory . 'en/data-center/' . $semantic_url;
									...
									// Absolute Path (SC)
									if($active_sc=='Yes') {
										$ab_semantic_url_sc = $real_root_directory . 'sc/data-center/' . $semantic_url;
									...
									// Relative Path (EN)
									if($active_en=='Yes') {
										$rel_semantic_url_en = 'en/data-center/' . $semantic_url;
									...
									// Relative Path (SC)
									if($active_sc=='Yes') {
										$rel_semantic_url_sc = 'sc/data-center/' . $semantic_url;
