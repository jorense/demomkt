...
<body>
	<div id="wrap">
        ...
        --><div id="content_wrap">
            <h1>Edit the content for the Stories section</h1>
		
            <div id="divider">&nbsp;</div>
            <h3 id="navigation_menu">Stories Index</h3>
            <p>The content of the Stories index</p>
            <?php 
				// Table variables
				$db_table = 'content_index';
				$input_form_id = '54';
				$reference_column = 'section';
				$reference_id = 'stories_index';
                    ...
                    <tbody>
						<?php
							...
							while($row = mysqli_fetch_array($result)) {
								...
								// Absolute Path (EN)
								if($active_en=='Yes') {
									$ab_semantic_url_en = $real_root_directory . 'en/stories/';
								...
								// Absolute Path (SC)
								if($active_sc=='Yes') {
									$ab_semantic_url_sc = $real_root_directory . 'sc/stories/';
								...
								// Relative Path (EN)
								if($active_en=='Yes') {
									$rel_semantic_url_en = 'en/stories/';
								...
								// Relative Path (SC)
								if($active_sc=='Yes') {
									$rel_semantic_url_sc = 'sc/stories/';
            ...
            <div id="divider">&nbsp;</div>
            <h3 id="navigation_menu">Stories Content</h3>
            <p>The content pages of the Stories section</p>
            <?php 
				// Table variables
				$db_table = 'content_index';
				$input_form_id = '53';
				$reference_column = 'section';
				$reference_id = 'stories_content';
				// Bulkremove Variables
				$br_form = 'stories_content_bulkremove';
				$br_button = 'stories_content_button';
				$br_checkbox = 'stories_content_check';
			?>
                    	...
                    	<form class="<?php echo $br_form; ?>" method="post" action="bulkremove.php">
							...
							<?php
								...
								while($row = mysqli_fetch_array($result)) {
									...
									// Absolute Path (EN)
									if($active_en=='Yes') {
										$ab_semantic_url_en = $real_root_directory . 'en/story/' . $semantic_url;
										$ab_semantic_url_en = '<a href="' . $ab_semantic_url_en . '" target="_blank">' . $ab_semantic_url_en . '</a>';	
									}
									else {
										$ab_semantic_url_en = '';
									...
									// Absolute Path (SC)
									if($active_sc=='Yes') {
										$ab_semantic_url_sc = $real_root_directory . 'sc/story/' . $semantic_url;
										$ab_semantic_url_sc = '<a href="' . $ab_semantic_url_sc . '" target="_blank">' . $ab_semantic_url_sc . '</a>';
									}
									else {
										$ab_semantic_url_sc = '';
									...
									// Relative Path (EN)
									if($active_en=='Yes') {
										$rel_semantic_url_en = 'en/story/' . $semantic_url;
										$rel_semantic_url_en = '<a href="../../' . $rel_semantic_url_en . '" target="_blank">' . $rel_semantic_url_en . '</a>';	
									}
									else {
										$rel_semantic_url_en = '';
									...
									// Relative Path (SC)
									if($active_sc=='Yes') {
										$rel_semantic_url_sc = 'sc/story/' . $semantic_url;
										$rel_semantic_url_sc = '<a href="../../' . $rel_semantic_url_sc . '" target="_blank">' . $rel_semantic_url_sc . '</a>';
									}
									else {
										$rel_semantic_url_sc = '';
