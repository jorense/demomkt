...
<body>
	<div id="wrap">
        ...
        --><div id="content_wrap">
            <h1>Edit the content for the Industry section</h1>
		
            <div id="divider">&nbsp;</div>
            <h3 id="navigation_menu">Industry Content</h3>
            <p>The content pages of the Industry section</p>
            <?php 
				// Table variables
				$db_table = 'content_index';
				$input_form_id = '53';
				$reference_column = 'section';
				$reference_id = 'industry_content';
				// Bulkremove Variables
				$br_form = 'industry_content_bulkremove';
				$br_button = 'industry_content_button';
				$br_checkbox = 'industry_content_check';
			?>
                    	...
                    	<form class="<?php echo $br_form; ?>" method="post" action="bulkremove.php">
							...
							<?php
								...
								while($row = mysqli_fetch_array($result)) {
									...
									// Absolute Path (EN)
									if($active_en=='Yes') {
										$ab_semantic_url_en = $real_root_directory . 'en/industry/' . $semantic_url;
									...
									// Absolute Path (SC)
									if($active_sc=='Yes') {
										$ab_semantic_url_sc = $real_root_directory . 'sc/industry/' . $semantic_url;
									...
									// Relative Path (EN)
									if($active_en=='Yes') {
										$rel_semantic_url_en = 'en/industry/' . $semantic_url;
									...
									// Relative Path (SC)
									if($active_sc=='Yes') {
										$rel_semantic_url_sc = 'sc/industry/' . $semantic_url;
