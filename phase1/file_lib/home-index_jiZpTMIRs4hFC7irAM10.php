								...
								<div class="carousel-inner">
										...
										<div class="container cl-i-inner">
											<div class="row">
												<div class="col-sm-12 col-md-4 slider-left text-left anim-content">
													<h2>Shanghai <br>Commercial Bank <br>ltd: iFlex Banking</h2>
													<p class="hidden-xs">Due to changing regulations of foreign banks China, Shanghai Commercial Bank sought to expand its business in Shenzhen with full operations in the foriegn currency banking business.</p>
													<span class="button--bubble__container mt2">
														<a href="#" class="button button--bubble pccw-btn">LEARN MORE</a>
												...
												<div class="col-sm-12 col-md-8 slider-right anim-content">
													<div class="sl-r-inner">
														<img class="img-auto" src="dist/images/home/slider1.jpg" width="661" height="371" alt="" title="">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="container">
											<div class="row">
												<div class="col-sm-12 col-md-4 slider-left text-left anim-content pull-right">
													<h2>Shanghai <br>Commercial Bank <br>ltd: iFlex Banking 2</h2>
													<p class="hidden-xs">Due to changing regulations of foreign banks China, Shanghai Commercial Bank sought to expand its business in Shenzhen with full operations in the foriegn currency banking business.</p>
													<span class="button--bubble__container mt2">
														<a href="#" class="button button--bubble pccw-btn">LEARN MORE</a>
														<span class="button--bubble__effect-container">
												...
												<div class="col-sm-12 col-md-8 slider-right anim-content pull-left">
													<div class="sl-r-inner">
														<img class="img-auto" src="dist/images/home/slider2.jpg" width="661" height="371" alt="" title="">
													</div>
												</div>
											</div>
										</div>
									...
									<div class="item">
										<div class="container">
											<div class="row">
												<div class="col-sm-12 col-md-4 slider-left text-left anim-content">
													<h2>Shanghai <br>Commercial Bank <br>ltd: iFlex Banking 3</h2>
													<p class="hidden-xs">Due to changing regulations of foreign banks China, Shanghai Commercial Bank sought to expand its business in Shenzhen with full operations in the foriegn currency banking business.</p>
													<span class="button--bubble__container mt2">
														<a href="#" class="button button--bubble pccw-btn">LEARN MORE</a>
														<span class="button--bubble__effect-container">
												...
												<div class="col-sm-12 col-md-8 slider-right anim-content">
													<div class="sl-r-inner">
														<img class="img-auto" src="dist/images/home/slider3.jpg" width="661" height="371" alt="" title="">
													</div>
												</div>
											</div>
										</div>
							...
							<div class="container">
								<div class="row">
									<div class="col-xs-12 col-lg-8 col-xs-offset-0 col-lg-offset-2 anim-content	animUp">
										...
										<p>PCCW Solutions, the flipshipof PCCW Group, is a leading IT services company in Hong Kong and mainland China.</p>
										<a href="#">LEARN MORE</a>
									</div>
								</div>
							</div>
								...
								<div class="row anim-content anim-ltr ex-l-inner">
									...
									<div class="col-xs-4 xp-list" data-id="1">
										<div class="xp-cons bp-rel">
											...
											<div class="shadow"></div>
											<div class="xp-caption bp-ab">
												<h3>Communication, Media &amp; Utilities</h3>
											</div>
											<div class="xp-caption bp-ab hoverme hidden-xs hidden-sm">
												<h3 class="learnmore">LEARN MORE <i class="fa fa-arrow-right"></i></h3>
											</div>
				...
				<div class="industries-hover-content bp-ab hidden-xs hidden-sm">
					<div class="xp-right i-h-c-content center-block">
						<div class="xp-list-data xp-list-data-0" style="display:none;">
							...
							<p>The tremedous economic developments in the Greater China regoin have brought both challenges and opportunities for the financial services industry.</p>
							<p>New business models, customer relationships and IT systems must keep up with the demands of the sophisticated global marketplace.</p>
						</div>
						<div class="xp-list-data xp-list-data-1" style="display:none;">
							<h2>Communication, Media &amp; Utilities</h2>
							<p>The tremedous economic developments in the Greater China regoin have brought both challenges and opportunities for the financial services industry.</p>
							<p>New business models, customer relationships and IT systems must keep up with the demands of the sophisticated global marketplace.</p>
						</div>
									...
									<div class="w-w-d-right">
										<div class="row anim-content anim-ltr">
											<div class="col-xs-4 w-w-d-list text-center" data-id="0">
												<a href="en/stories/">
													<img class="img-fluid" src="dist/images/icons/icon1.svg" width="100" height="100" alt="" title="">
													<h3>Data Center</h3>
												</a>
											</div>
											<div class="col-xs-4 w-w-d-list text-center" data-id="1">
												<a href="en/stories/">
													<img class="img-fluid" src="dist/images/icons/icon2.svg" width="100" height="100" alt="" title="">
													<h3>Cloud</h3>
												</a>
											</div>
											<div class="col-xs-4 w-w-d-list text-center" data-id="2">
												<a href="en/stories/">
													<img class="img-fluid" src="dist/images/icons/icon3.svg" width="100" height="100" alt="" title="">
													<h3>Managed Services</h3>
												</a>
											</div>
											<div class="col-xs-4 w-w-d-list text-center" data-id="3">
												<a href="en/stories/">
													<img class="img-fluid" src="dist/images/icons/icon4.svg" width="100" height="100" alt="" title="">
													<h3>Application Development</h3>
												</a>
											</div>
											<div class="col-xs-4 w-w-d-list text-center" data-id="4">
												<a href="en/stories/">
													<img class="img-fluid" src="dist/images/icons/icon5.svg" width="100" height="100" alt="" title="">
													<h3>Digital &amp; IoT</h3>
												</a>
											</div>
											<div class="col-xs-4 w-w-d-list text-center" data-id="5">
												<a href="en/stories/">
													<img class="img-fluid" src="dist/images/icons/icon6.svg" width="100" height="100" alt="" title="">
								...
								<div class="row">
									<div class="col-sm-12 col-md-8 anim-content animUp">
										<div class="pull-left test-img">
											<img class="img-responsive img-circle" src="dist/images/home/profile.jpg" width="99" height="99" alt="" title="">
										</div>
										...
										<div class="testimonial-content bp-rel anim-content animUp">
											<p>We are pleased to partner with PCCW SOlutions to implement our first RFID-enabled warehouse management system. The automated system streamlined our workflow to distribute products in high quality and customer satistaction.</p>
									...
									<div class="col-sm-12 col-md-4 t-s-right anim-content animUp">
										<div class="t-s-r-inner bp-rel">
											<h4>Follow Us</h4>
											<p>Soluta integre cotidieque eu est, id sed quod quando incorrupte.</p>
											<div class="ts-sns mt1">
												<a class="linkedin" href="#"><i class="pw-linkedin-circle white"></i></a>
												<a class="fb" href="#"><i class="pw-facebook-circle white"></i></a>
												<a class="twitter" href="#"><i class="pw-twitter-circle white"></i></a>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="row">
						<div class="col-sm-12 col-md-4 no-padding">
							<div class="h-w-inner anim-content anim-ltr">
								...
								<p>PCCW Solutions helps service providers grow their business, boost operational efficiencies and reduce costs by tailoring solutions to customers needs, riding on its industry espertise plus an empressive track  recored ot innovation.</p>
								...
								<a class="h-w-r-i-tag" href="en/stories/">
									<div class="h-w-r-inner bp-rel">
										...
										<div class="h-w-caption bp-ab">
											...
											<h3>Tianjin Great Wall Binyin Automotive Financial Company</h3>
										</div>
									</div>
								</a>
							</div>
							<div class="col-sm-12 col-md-6 no-padding">
								<a class="h-w-r-i-tag" href="en/stories/">
									<div class="h-w-r-inner bp-rel">
										...
										<div class="h-w-caption bp-ab">
											<h4>COMMUNICATIONS, MEDIA &amp; UTILITIES</h4>
				...
				<div class="container-fluid">
					<div class="container anim-content animUp zx5 bp-rel">
						<div class="h-what-title">
							...
							<p>Stay connected with us and stay up to date on the latest industry news and insight.</p>
						</div>
							...
							<div class="row anim-content animUp h-whats-new-inner">
								<div class="col-xs-6 col-sm-6 col-md-4 w-n-l-holder pt3">
									<div class="w-n-list">
										...
										<div class="w-n-content bp-rel clearfix">
											<a href="#"><h3>Enhancing Cyber Security</h3></a>
								...
								<div class="col-xs-6 col-sm-6 col-md-4 w-n-l-holder pt3">
									<div class="w-n-list">
										...
										<div class="w-n-content bp-rel clearfix">
											<a href="#"><h3>Accelerating Business with Digitalization</h3></a>
											<a class="learn-more pull-left" href="#">LEARN MORE</a>
											<div class="w-n-share pull-right bp-rel">
												<i class="fa fa-share-alt share-btn"></i>
												<div class="w-n-share-holder bp-ab">
								...
								<div class="col-xs-6 col-sm-6 col-md-4 w-n-l-holder pt3">
									<div class="w-n-list">
										...
										<div class="w-n-content bp-rel clearfix">
											<a href="#"><h3>e-Government Infrastructure Services</h3></a>
											<a class="learn-more pull-left" href="#">LEARN MORE</a>
											<div class="w-n-share pull-right bp-rel">
												<i class="fa fa-share-alt share-btn"></i>
												<div class="w-n-share-holder bp-ab">
								...
								<div class="col-xs-6 col-sm-6 col-md-4 w-n-l-holder pt3">
									<div class="w-n-list">
										<a href="#">
											<div class="w-n-img-holder">
												<img class="img-auto" src="dist/images/home/whats_new_thumb6.jpg" width="314" height="230" alt="" title="">
												<p>SERVER</p>
											</div>
										</a>
										<div class="w-n-content bp-rel clearfix">
											<a href="#"><h3>Rackspace Hosting: Data Center Design and Build</h3></a>
											<a class="learn-more pull-left" href="#">LEARN MORE</a>
											<div class="w-n-share pull-right bp-rel">
												<i class="fa fa-share-alt share-btn"></i>
												<div class="w-n-share-holder bp-ab">
								...
								<div class="col-xs-6 col-sm-6 col-md-4 w-n-l-holder pt3">
									<div class="w-n-list">
										<a href="#">
											<div class="w-n-img-holder">
												<img class="img-auto" src="dist/images/home/whats_new_thumb4.jpg" width="314" height="230" alt="" title="">
												<p>LOGISTIC</p>
											</div>
										</a>
										<div class="w-n-content bp-rel clearfix">
											<a href="#"><h3>Electroplating Production with RFID</h3></a>
											<a class="learn-more pull-left" href="#">LEARN MORE</a>
											<div class="w-n-share pull-right bp-rel">
												<i class="fa fa-share-alt share-btn"></i>
												<div class="w-n-share-holder bp-ab">
											...
											<a class="w-n-sns new bp-ab" href="#"><i class="pw-new-circle white"></i></a>
										</div>
										<span class="hover-top"></span>
										<span class="hover-bottom"></span>
									</div>
								...
								<div class="col-xs-6 col-sm-6 col-md-4 w-n-l-holder pt3">
									<div class="w-n-list">
										<a href="#">
											<div class="w-n-img-holder">
												<img class="img-auto" src="dist/images/home/whats_new_thumb5.jpg" width="314" height="230" alt="" title="">
												<p>SMART PARKING</p>
											</div>
										</a>
										<div class="w-n-content bp-rel clearfix">
											<a href="#"><h3>A global parking business</h3></a>
											<a class="learn-more pull-left" href="#">LEARN MORE</a>
											<div class="w-n-share pull-right bp-rel">
												<i class="fa fa-share-alt share-btn"></i>
												<div class="w-n-share-holder bp-ab">
					...
					<div class="container">
						<div class="row anim-content anim-ltr">
							<div class="col-sm-12 col-md-4 anim-content anim-ltr mb2">
								<h3>The Figures of Sucess</h3>
								<p>Leader IT solutions and business processes system integration, applications development and technical integration</p>
								<a href="#">DISCOVER OUR HERITAGE</a>
							</div>
			...
			<div class="layer h-q-t-deliver bp-rel pt5 pb5 text-center">
				<div class="container-fluid">
					<div class="container anim-content animUp">
						<h2>Qualified to Deliver</h2>
						<div class="row">
							<div class="col-sm-12 col-md-10 col-sm-offset-0 col-md-offset-1">
								<p>Strong references in state-of-the-Art digital implementations. <br>Application management, infrastructure management, managed services and outsourcing.</p>
							</div>
						</div>
