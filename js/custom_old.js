...
$(window).load(function() {
	...
	setTimeout(function() {
		...
		if (hash_link[1] === 'FanlingOnTing' || hash_link[1] === 'Cyberport' || hash_link[1] === 'MCX10' || hash_link[1] === 'FanlingOnLok' || hash_link[1] === 'TseungKwanO' || hash_link[1] === 'Guangzhou' || hash_link[1] === 'FoTan') {
	...
	$('.main-dropdown .clickScroll').click(function (e) {
		e.preventDefault();
		var id = $(this).data('id');
